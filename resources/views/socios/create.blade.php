...
@section('content')
  ...
  <div class="card card-default">
    ...
    <form method="POST" action="{{action('SocioController@store')}}">
      ...
      <div class="card card-default mt-4 bg-light">
        <div class="card-header">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="date" class="form-control" name="cuota[fecha_pago]" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Importe</label>
                <input type="number" class="form-control" name="cuota[importe]" required>
              </div>
            </div>
          </div>
          <h5>Periodo</h5>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Desde</label>
                <input type="date" class="form-control" name="cuota[fecha_desde]" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Hasta</label>
                <input type="date" class="form-control" name="cuota[fecha_hasta]" required>
              </div>
            </div>
          </div>
        </div>
